            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="aa-header-bottom-area">
                        ...
                        <div class="aa-logo">
                            <!-- Text based logo -->
                            <a href="/src/main/webapp">
                                <span class="fa fa-shopping-cart"></span>
                                <p>Mini<strong>Super</strong> <span>Tu Compañero</span></p>
                            </a>
                        </div>
                        <!-- / logo  -->
                        <!-- cart box -->
                        ...
                        <form ng-submit="search()" ng-controller="searchCtrl">
	                        <div class="aa-search-box">
		                        <input type="text" ng-model="keyword" placeholder="Producto...">
            ...
            <div class="navbar navbar-default" role="navigation">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="/src/main/webapp">Inicio</a></li>
