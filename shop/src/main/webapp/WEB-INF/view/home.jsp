                ...
                <ul class="seq-canvas">
                    ...
                    <li>
                        ...
                        <div class="seq-title">
                            ...
                            <a data-seq href="/pd/s" class="aa-shop-now-btn aa-secondary-btn">COMPRE AHORA</a>
                            </c:if>
                            <c:if test="${not empty slider.sliderLink}">
                            <a data-seq href="/pd/s?mc=${slider.sliderLink}" class="aa-shop-now-btn aa-secondary-btn">COMPRE AHORA</a>
                        	</c:if>
                        </div>
                    </li>
                    </c:forEach>
                    ...
                    <div class="aa-popular-category-area">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="latest">
                                ...
                                <a class="aa-browse-btn" href="#">Buscar Todos los Productos <span
                                        class="fa fa-long-arrow-right"></span></a>
                            </div>
